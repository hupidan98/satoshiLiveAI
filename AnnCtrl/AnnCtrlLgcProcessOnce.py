...
#     #Get remain announcement from the announcement_buffer
...
#          # Write a new paragraph, Sperate into pieces and put in annouuncement buffer
#         newAnnsTxt = AnnCtrlLgcGPTProcess.generate_new_Announcement(newTheme)
#         newAnnsTxt = newAnnsTxt.strip("```json").strip("```")

#         # print(newAnnsTxt)
#         newAnns = json.loads(newAnnsTxt)
...
#     #Sent to the instruction buffer
...
#     #Mark the announment_buffer as processed
